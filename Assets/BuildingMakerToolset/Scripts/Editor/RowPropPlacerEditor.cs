...
namespace BuildingMakerToolset.PropPlacer
{
    ...
    public class RowPropPlacerEditor : Editor
    {
        ...
        void DrawPrefabView(RowPropPlacer tgt)
        {
            ...
            hight = Mathf.Clamp( Mathf.CeilToInt( totalPrefabCount / vButtons ) * (buttonHight + spacing), buttonHight + 2 * spacing, hight );
            ...
            prefabViewscrollPosition = GUILayout.BeginScrollView( prefabViewscrollPosition, false, true, GUIStyle.none, "verticalScrollbar", prefabBox, GUILayout.Height( hight ),GUILayout.Width(width));
            Rect scrollArea = new Rect( 0, prefabViewscrollPosition.y, width, hight );
            int colum = 0;
            int row = 0;
            ...
            if (totalPrefabCount > 0)
            {
                ...
                for (int i = 0; i < totalPrefabCount; i++)
                {
                    ...
                    if (sourcePrefab == null)
                        continue;
                    Texture icon = AssetPreview.GetAssetPreview( sourcePrefab );
        ...
        static GameObject InstantiateProp(GameObject go, RowPropPlacer spwn)
        {
            ...
            {
                rpp.TransferGroupMask( spwn.prefabGroups, spwn.groupMask );
            }
